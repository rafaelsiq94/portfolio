...
const Contact = () => {
  ...
  return (
    <div id='contact' className='w-full lg:h-screen p-24'>
      <div className='max-w-[1240px] m-auto flex flex-col justify-center h-full '>
        <h2 className='py-4'>Say <span className='text-green'>Hi</span>!</h2>
              ...
              >
                <div className='grid md:grid-cols-2 gap-4 w-full py-2'>
                  <div className='flex flex-col'>
                    ...
                    <input
                      className='border-2 rounded-lg p-3 flex border-text2'
                      type='text'
                      name='name'
                      value={name}
                ...
                <div className='flex flex-col py-2'>
                  ...
                  <textarea
                    className='border-2 rounded-lg p-3 border-text2'
                    rows='5'
                    name='message'
                    value={message}
